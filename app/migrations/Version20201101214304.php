...
final class Version20201101214304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mail (id INT AUTO_INCREMENT NOT NULL, recipient_id INT NOT NULL, subject VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, sent_at DATETIME, UNIQUE INDEX UNIQ_5126AC48E92F8F78 (recipient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
